...
```{r}
org = read_csv("../data/2025-08-06_terrainEE/staticTerrain_ORG.csv")
```
...
```{r}
( org_subset = org %>% 
  dplyr::select(id, lat, lon, prjct_n, fireYr) %>%
  rename(ID=id, project_name = prjct_n) %>%
  mutate(fireYr = as.character(fireYr))
)
```
# Spatialize
...
st_write(lc_pts_WGS84, "../outputs/combustion_pts_gpkg/lc_pts_WGS84_2025-08-04.gpkg")

st_write(lcc_pts_WGS84, "../outputs/combustion_pts_gpkg/lcc_pts_WGS84_2025-08-04.gpkg")

st_write(fisl_pts_WGS84, "../outputs/combustion_pts_gpkg/fisl_pts_WGS84_2025-08-04.gpkg")

st_write(org_pts_WGS84, "../outputs/combustion_pts_gpkg/org_pts_WGS84_2025-08-06.gpkg")
```
