...
```{r}
org_fwi_list = list.files(path="../data/2025-08-08_combustion_layer_update/fwi_org", pattern='*.csv', full.names = TRUE)
#org_fwi_list
```
...
```{r}
write_csv(org_fwi_sub, "../outputs/2025-08-18_cleaned/csv/2025-08-31_Org_fwi.csv")
```
