...
clean_select_FWI <- function(df){df %>% 
  ...
  select(ID, date, DOB_lst, fireYr, BUI, DC, DMC, FFMC, FWI, ISI )
}
```
...
```{r}
write_csv(fisl, "../outputs/LCC_cleaned/csv/2025-06-11_Fisl_fwi_gfwed.csv")
write_csv(lc, "../outputs/LCC_cleaned/csv/2025-06-11_LC_fwi_gfwed.csv")
write_csv(lcc, "../outputs/LCC_cleaned/csv/2025-06-11_LCC_fwi_gfwed.csv")
```
